...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    turnAbsoluteEncoder =
        new AnalogInput(
            switch (module) {
              case 0 -> DriveConstants.frontLeftTurnEncoderId;
              case 1 -> DriveConstants.frontRightTurnEncoderId;
              case 2 -> DriveConstants.backLeftTurnEncoderId;
              case 3 -> DriveConstants.backRightTurnEncoderId;
              default -> 0;
            });
    ...
    driveConfig
        .inverted(DriveConstants.driveInverted)
    ...
    turnConfig
        ...
        .positionWrappingInputRange(
            turnPIDMinInput * DriveConstants.turnMotorReduction,
            turnPIDMaxInput * DriveConstants.turnMotorReduction)
  ...
  public void setTurnPosition(Rotation2d rotation) {
    double setpoint =
        MathUtil.inputModulus(
                rotation.plus(relativeEncoderOffset).getRadians(), turnPIDMinInput, turnPIDMaxInput)
